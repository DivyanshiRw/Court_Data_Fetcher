...
def test_save_query(monkeypatch):
    """Ensure save_query() doesn't raise any exceptions with mock DB"""
...
def test_fetch_case_details_structure(monkeypatch):
    """Ensure fetch_case_details() returns expected dictionary structure"""
    ...
    assert result["pdf_link"].endswith(".pdf")
